...
export const ErrorCodes = {
  ...
  BLOCKCHAIN_TX_REVERTED: 'BLOCKCHAIN_TX_REVERTED',
  BLOCKCHAIN_EVENT_NOT_FOUND: 'BLOCKCHAIN_EVENT_NOT_FOUND',
  AUCTION_NOT_FOUND: 'AUCTION_NOT_FOUND',
  BID_NOT_COMMITTED: 'BID_NOT_COMMITTED',
  INVALID_REVEAL_SECRET: 'INVALID_REVEAL_SECRET',
